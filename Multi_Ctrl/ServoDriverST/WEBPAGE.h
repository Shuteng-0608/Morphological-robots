...
<body>
    ...
    <p>
    <input type="number" id="servoID" placeholder="Servo ID" min="0">
    <input type="number" id="targetAngle" placeholder="Angle" min="0" max="180">
    <label align="center">
    <button class="button" onclick="toggleCheckbox(1, 22, document.getElementById('servoID').value, document.getElementById('targetAngle').value);">Set Angle</button>
    </label>
    <script>
